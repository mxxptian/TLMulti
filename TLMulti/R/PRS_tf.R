...
#' @param X The individual-level data of the target samples (unnormalized).
#' @param PATH_TO_REF The data path of reference panel for the target population.
#' @param PATH_TO_TEST The data path of reference test panel for the target population.
#' @param PATH_TO_EUR The data path of reference panel for the informative auxiliary population
#' @param tar_pheno The phenotype of the target population.
...
#'
#'
PRS_tf <- function(ss_e, ss_a, info_LD, tar_LD, X, PATH_TO_EUR, PATH_TO_REF, PATH_TO_TEST, tar_pheno, sample_r = NULL,
